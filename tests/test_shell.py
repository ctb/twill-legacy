...
def test_shell_specific(url: str):
    execute_shell('test_shell.twill', initial_url=url,
    ...
    expected_lines = [
        ...
        'Help for command exit:', '>> exit [<code>]',
        '    Exit twill, with the given exit code'
        ' (defaults to 0, "no error").',
        'Print version information.',
        "Imported extension module 'shell_test'.",
        'testing extension', 'raising errors',
